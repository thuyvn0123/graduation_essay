...
class ProductSimilarity
{
    ...
    public function setRoomWeight(float $weight): void
    {
    ...
    {
        $productAFeatures = $productA->p_collection;
        $productBFeatures = $productB->p_collection;
        ...
        return array_sum([
            ...
            (Similarity::jaccard((string)$productA->rp_id, (string)$productB->rp_id) * $this->roomWeight),
            (Similarity::jaccard((string)$productA->tp_id, (string)$productB->tp_id) * $this->categoryWeight)
        ]) / ($this->roomWeight + $this->featureWeight + $this->priceWeight  + $this->categoryWeight );
    }
}
